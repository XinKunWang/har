...
Note that we have an average accuracy of 99.98% in the 10 folds of the validation. As the model seems to be the best possible there is no need to change anything else.
